	...
	<section class="py-5">
		...
		<div class="row ">
				  ...
				  <fieldset disabled="" style="margin-left:500px; width:200px;">
				    ...
				    <input class="form-control" id="disabledInput" type="text" placeholder="10,000 P" disabled="">
				  </fieldset>
				  
				  
				  
                    <div class="col-lg-4 col-sm-6 mb-4 por"  style="margin-left:300px;">
                        <div class="card h-100">
                            <a href="#!"><img class="card-img-top" src="https://via.placeholder.com/700x400" alt="..."></a>
                            <div class="card-body">
                                <h4 class="card-title"><a href="#!">최근 본 전시</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 por" style="margin-left:30px;">
                        <div class="card h-100">
                            <a href="#!"><img class="card-img-top" src="https://via.placeholder.com/700x400" alt="..."></a>
                            <div class="card-body">
                                <h4 class="card-title"><a href="#!">최근 본 이벤트</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 por" style="margin-left:300px;">
                        <div class="card h-100">
                            <a href="#!"><img class="card-img-top" src="https://via.placeholder.com/700x400" alt="..."></a>
                            <div class="card-body">
                                <h4 class="card-title"><a href="#!">찜목록</a></h4>
